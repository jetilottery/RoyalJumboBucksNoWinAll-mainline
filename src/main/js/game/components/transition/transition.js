define(require => {
    ...
    function doTransition(toBonus) {
        ...
        if (_toBonus) {
            ...
            _transitionLand.state.setAnimationByName(0, 'land_transition_OUT', false);
            _transitionPort.state.setAnimationByName(0, 'port_transition_OUT', false);
        }
    }
    /**
     * Swap screens
    ...
    function swapScreen(data) {
        ...
        Tween.fromTo(_baseGame, duration, {
            alpha: toBonus ? 1 : 0
        }, {
            alpha: toBonus ? 0 : 1
        });
        Tween.fromTo(_bonusGame, duration, {
            alpha: toBonus ? 0 : 1
        }, {
            alpha: toBonus ? 1 : 0,
            onComplete: function() {
